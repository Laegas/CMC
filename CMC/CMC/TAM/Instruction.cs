...
namespace CMC.TAM
{
    public class Instruction
    {
        ...
        public void write( BinaryWriter output )
        {
            ...
            output.Write( ToBigEndian(op) );
            output.Write( ToBigEndian( r) );
            output.Write( ToBigEndian( n) );
            output.Write( ToBigEndian( d) );
        }

        private byte[] ToBigEndian(int num )
        {
