...
namespace CMC.TAM
{
    class Machine
    {
        ...
        /// <summary>
        /// NOTES
        /// Static link points to the frame that textually encloses the current frame. For function definitions static link should always be 0 (we think)
        /// dynamic link points to the frame directly before the current frame on the stack
        /// Return address points to the command imediately following the call instruction
        /// </summary>
        ...
        public readonly static int
          ...
          PBr = 2,  
          PTr = 3,
          SBr = 4,  //stack base register
          STr = 5,  //stack top
          HBr = 6,
          HTr = 7,
          LBr = 8,  // top most frame
          L1r = LBr + 1, //previouse or enclosing stack frames
          L2r = LBr + 2,
          L3r = LBr + 3,
          L4r = LBr + 4,
          L5r = LBr + 5,
